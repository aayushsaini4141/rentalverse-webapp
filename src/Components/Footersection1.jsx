    ...
    >
      <Box textAlign={"justify"} padding="10px">
        <Text fontWeight={"semibold"}>
          Rentalverse NEW DELHI: The Budget Way To A Better Lifestyle!
        </Text>
        <Text color={"rgb(109,109,109)"}>
          Rentalverse is a leading Indian rental brand. We offer top-quality
        ...
        <Text color={"rgb(109,109,109)"} marginTop="20px">
          ...
          doorstep delivery and installation all over New delhi.
        </Text>
      </Box>
