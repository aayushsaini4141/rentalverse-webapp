  ...
  const data = [
    {
      ...
      comment:
        "Rentalverse was unbelievably helpful. Never thought that setting up a new place would be just few clicks away. The customer supportstaff was on their toes to help me. Anytime I need something for my house, Rentomojo has it. :)",
    },
    {
      id: 2,
      image:
      ...
      name: "Kushal Tiwari",
      comment:
        "Marriage comes with a lot of unavoidable expenses in India and spending a big chunk of your savings on furniture and white goods, could be a big challenge. Rentalverse not just took away all our worries but in fact went to the extent of spoiling us.  .",
    },
    {
      id: 3,
      image:
    ...
    },
    {
      ...
      name: "Anjali Sharma",
      comment:
        "I got to know about Rentalverse through a friend and looked up for AC on their website and finally rented one. The delivery guys installed the AC in 2 days. And with a sucha low deposit and rent, I didn't have to spenda whole lot for my comfort. Thank you RentoMojo, for being so easy breezy on my pocket.",
    },
    {
      id: 6,
      image:
      ...
      comment:
        "I was suddenly asked to move to Chennai from Bengaluru in couple of days. Everything was garbled for me and huge tension of getting apartment, buying furnitures, selling while going back to Bangalore. Thanks to Rentalverse for excellent budgeted plans.",
    },
  ];
